...
if (isset($_SESSION['admin'])) {
	...
	case 'editar_noticia' :
		...
		echo "
			...
			<p><img style='width:15%;' src='../galeria/noticias/" . $fila['imagen'] . "'></p>
			<p><style='width: 25%;' img src='../galeria/noticias/" . $fila['imagen'] . "'></p>
			<p><input type='file' name='archivo'/></p>
			<p><label>NOTICIA*</label></p>
	...
	case 'insertar' :
		...
		if ($archivo != "") {
			...
			unlink('../galeria/noticias/' . $fila['imagen']);

			// guardamos el archivo a la carpeta files
			$destino = "../galeria/noticias/" . $prefijo . "_" . $archivo;
